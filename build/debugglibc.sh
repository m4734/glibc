...
SOURCE_DIR="/home/cgmin/20210402/glibc"
BUILD_DIR="/home/cgmin/20210402/glibc/build/"
CMD_FILE="/home/cgmin/20210402/glibc/build/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
WAIT_FOR_DEBUGGER=1 /home/cgmin/20210402/glibc/build/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
